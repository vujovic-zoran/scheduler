...
<?php echo $this->Form->create('AppointmentForm'); ?>
	<fieldset>
		<legend><?php echo __('Edit Appointment Form'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AppointmentForm.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('AppointmentForm.id'))); ?></li>
