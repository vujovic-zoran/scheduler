<div class="services index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('reminder_days_prior'); ?></th>
			<th><?php echo $this->Paginator->sort('reminder_message'); ?></th>
			<th><?php echo $this->Paginator->sort('min_days_before'); ?></th>
			<th><?php echo $this->Paginator->sort('max_days_before'); ?></th>
			<th><?php echo $this->Paginator->sort('confirmation_message'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($service['Service']['length']); ?>&nbsp;</td>
		<td><?php echo h($service['Service']['reminder_days_prior']); ?>&nbsp;</td>
		<td><?php echo h($service['Service']['reminder_message']); ?>&nbsp;</td>
		<td><?php echo h($service['Service']['min_days_before']); ?>&nbsp;</td>
		<td><?php echo h($service['Service']['max_days_before']); ?>&nbsp;</td>
		<td><?php echo h($service['Service']['confirmation_message']); ?>&nbsp;</td>
		<td class="actions">
