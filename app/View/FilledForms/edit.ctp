...
<?php echo $this->Form->create('FilledForm'); ?>
	<fieldset>
		<legend><?php echo __('Edit Filled Form'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('FilledForm.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('FilledForm.id'))); ?></li>
